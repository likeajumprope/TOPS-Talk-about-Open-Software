...
-   Opt-out mechanisms exist — The Stack allows developers to request removal of their code.
-   Feeding code into commercial LLMs (e.g. ChatGPT free tier) may include it in training data — always check the terms of service.
...
::: {.column width="40%"}
![Check if your code is in The Stack](imgs/AmIinthestack.png){width="500"}
:::
:::
...
::: mylist
LLMs are fantastic teachers — try asking:
...
Researchers without a formal CS background, non-native English speakers, and those from under-resourced institutions can now write and document code more confidently — a genuine democratization of scientific computing.
:::
