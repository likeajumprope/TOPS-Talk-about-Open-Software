...
::: columns
::: {.column width="50%"}
-   Post Doctoral Fellow at the Donders Institute for Brain, Congition and Behaviour\
-   Using machine learning models to create normative models on large neuroimaging data sets
-   Studying computer science\
-   Involved in several open soucre and open science initiatives
-   Cat lover\
:::
...
-   Making software more open by following the principles has benefits and challenges, which are related. </br>
