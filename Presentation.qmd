...
::: columns
::: {.column width="50%"}
-   Post Doctoral Fellow at McGill University, Canada.\
...
-   At the moment, all code on github is being used to train LLMs.

-   [Latest example: The Stack by the HuggingFace](https://huggingface.co/spaces/bigcode/in-the-stack)

-   Feeding code into ChatGPT (unpaid version) incorporates the code into the training database.
:::
...
-   **Usage example** — at least one working, copy-pasteable example
-   **Citation** — how to credit the software in a paper
-   **License** — what others are allowed to do with it
-   **Contact / contribution info** — who to reach and how to contribute
:::
:::

::: {.column width="45%"}
::: {.fragment .fade-in}
A README without a usage example is like a paper without an abstract: technically complete, but practically useless.
:::
...
## Citing Open Source Code and Software: {.scrollable}
...
::: {.fragment .fade-in}
Software checked-out from a Github with a DOI:
:::
