...
|--------------|----------------------------------------------------------|
| **Transparency**        | Accessible materials enable everyone to build on each other's work, make informed decisions, and understand their impact.                                          |
| **Collaboration**       | Open participation and shared projects unlock new possibilities. Open standards ensure contributions can continue long-term.                                       |
| **Share Early & Often** | Early sharing, iterative work and rapid prototypes lead to faster discoveries and better solutions. Experimentation and getting early feedback fosters innovation. |
| **Inclusivity**         | The best ideas come from diverse perspectives. Including varied voices ensures better decisions and allows the strongest ideas to thrive.                          |
| **Community**           | Communities thrive on shared goals and values, where collective purpose outweighs individual interests.                                                            |
:::
...
-   Ideally, the code is located in a long-term repository and tagged with a DOI.
